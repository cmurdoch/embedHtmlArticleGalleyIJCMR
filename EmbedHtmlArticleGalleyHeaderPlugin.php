...
/**
 * @file plugins/generic/embedHtmlArticleGalleyIJCMR/EmbedHtmlArticleGalleyIJCMRPlugin.inc.php
 *
 * Copyright (c) 2014-2022 Simon Fraser University
 * Copyright (c) 2003-2022 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class EmbedHtmlArticleGalleyIJCMRPlugin
 * @ingroup plugins_generic_embedHtmlArticleGalleyIJCMR
 *
 * @brief Class for EmbedHtmlArticleGalleyIJCMR plugin
 */

namespace APP\plugins\generic\embedHtmlArticleGalleyIJCMR;
...
class EmbedHtmlArticleGalleyIJCMRPlugin extends GenericPlugin
{
    public $application;
    ...
    {
        return __('plugins.generic.embedHtmlArticleGalleyIJCMR.displayName');
    }
    ...
    {
        return __('plugins.generic.embedHtmlArticleGalleyIJCMR.description');
    }
...
if (!PKP_STRICT_MODE) {
    class_alias('\APP\plugins\generic\embedHtmlArticleGalleyIJCMR\EmbedHtmlArticleGalleyIJCMRPlugin', '\EmbedHtmlArticleGalleyIJCMRPlugin');
}
